...
class GLWidget(QOpenGLWidget):
    ...
    def paintGL(self):
        self.ctx.glClearColor(*BG_COLOR, 1)
        self.ctx.glClear(self.ctx.GL_COLOR_BUFFER_BIT | self.ctx.GL_DEPTH_BUFFER_BIT)

        # Update and render scene
        self.scene.render()

        self.time += 0.016  # Approximation for demo purposes
...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        self.setCentralWidget(MusicPlayer())
